...

{
...

    {
        ...
        private todotntEntities db = new todotntEntities();
...

        {
            ...
            return Json(ads.Select(a => new { isAd = true, url = a.Url, name = a.Title, cat = GetCategory(a.CategoryID), description = a.Detail, lat = a.Latitude, @long =  a.Longitude}), JsonRequestBehavior.AllowGet);
        ...
        private string GetCategory(int? id)
        {
            ...
            var item = db.Categories.FirstOrDefault(c => c.ID == idVaL);
